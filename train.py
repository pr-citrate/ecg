...
def parse_args():
    ...
    parser.add_argument('--scheduler', type=str,
                        choices=['step', 'cosine', 'plateau'], default='step')
...
def main():
    ...
    # compute pos_weight for focal/bce loss
    ...
    print(f"[Init] pos_weight_tensor computed", flush=True)
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        train_loss = train_one_epoch(
            ...
            lambda p, t: classification_loss(
                             p, t,
                             loss_type='focal',
                             gamma=2.0,
        ...
        print(f"[Epoch {epoch}] Train {train_loss:.4f}  Val {val_loss:.4f}  "
              ...
              f"AUROC {val_metrics['mean_auroc']:.3f}", flush=True)
